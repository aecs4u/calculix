...
fn main() {
    ...
    let legacy_root = manifest_dir.join("../../calculix_migration_tooling/ccx_2.23/src");
    if !legacy_root.is_dir() {
        panic!(
            "legacy solver tree not found at {}",
    ...
    let out_file = out_dir.join("legacy_source_units.rs");
